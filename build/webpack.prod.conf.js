...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new ExtractTextPlugin({
      ...
      // set the following option to `true` if you want to extract CSS from codesplit
      // chunks into this main css file as well. This will result in *all* of your
      // app's CSS being loaded upfront.
      allChunks: false
    }),
