  ...
  <el-aside width="200px">
    <el-menu
      ...
      <el-submenu index="/education/exam/examQuestions">
        ...
        <el-menu-item-group>
          <el-menu-item index="/education/exam/examQuestions">考题管理</el-menu-item>
          <el-menu-item index="/education/exam/examPaper">考卷管理</el-menu-item>
        </el-menu-item-group>
      </el-submenu>
      <el-menu-item index="/education/eduRecord">
        <span slot="title">教育记录</span>
      </el-menu-item>
      <el-submenu index="/education/expenses">
        <template slot="title">
          <span>资费管理</span>
        </template>
        <el-menu-item-group>
          <el-menu-item index="/education/expenses">订单与消费</el-menu-item>
          <el-menu-item index="/education/invoice">发票管理</el-menu-item>
        </el-menu-item-group>
      </el-submenu>            
    </el-menu>
