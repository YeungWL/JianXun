		...
		<article class="login-content">
            ...
            <el-form class="form-horizontal" :model="loginForm" :rules="loginRules" ref="loginForm">
              ...
              <el-form-item class="login-yzm" prop="code">
                <el-input placeholder="验证码" :maxlength="4" class='yzm'  @keyup.enter.native="handleLogin()"  v-model="loginForm.code" @blur="checkImgCode(false)" @change="checkImgCode(true)">
                </el-input>
    ...
    checkImgCode(isChange) {
      if (this.loginForm.imgCode) {
        ...
        this.$api.checkImgCode(data).then(res => {
          ...
          console.log(isChange+111)    
        })
        console.log(isChange+222) 
        return isChange
      }
    },               
    // 登录
