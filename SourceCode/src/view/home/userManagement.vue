...
export default{
  data () {
    return {
      ifShowToolbar: false
        //   myChart1: this.$echarts.init(this.$refs.main1),
        //   myChart2: this.$echarts.init(this.$refs.main2),
  ...
  mounted () {
    let option1 = {
      ...
      xAxis: {
        ...
        data: ['上海', '北京', '深圳', '广州', '天津', '杭州', '武汉', '重庆', '南昌', '福州', '厦门', '苏州']
      },
      yAxis: {},
      series: [{
        name: '人口总数',
        ...
        data: [5550, 2550, 346, 6610, 150, 20, 241, 5645, 20, 36, 10, 60]
      }]
    }
